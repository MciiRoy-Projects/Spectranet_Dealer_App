...
import {Wrapper, Card, ColoredInput, P, H1, H2, Button, Touch} from '../partials/_components';
				...
				<ScrollView showsVerticalScrollIndicator={false}>
					...
					<Card>
						<View style={styles.form}>
							...
							<ColoredInput placeholder="*Dealer ID" onChangeText={ID => this.setState({ID})} value={ID} style={styles.input} type="next" />
						...
						{isLoading ? (
							...
							<Button text="SIGN IN" style={styles.btn} onPress={() => this.loginApp()} />
						)}
					</Card>
